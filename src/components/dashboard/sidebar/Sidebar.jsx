  ...
  return (
    <div className="col-auto col-md-3 col-xl-3 px-sm-2 px-0 bg-white shadow">
      <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
        ...
        <p className="text-secondary fs-4">{auth.contribuyente}</p>
        <p className="text-secondary fs-4">{auth.email}</p>
        
        <ul
          className="nav nav-pills w-100 flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
          id="menu"
        >
          <li className="text-secondary fs-3 mt-4">Organización</li>
          <li className="nav-item d-flex align-items-center mt-3 seleccionar w-100">
            ...
            <Link
              className="nav-link text-dark fs-3 m-0"
          ...
          <li className="nav-item d-flex align-items-center mt-3 seleccionar w-100">
            ...
            <Link className="nav-link text-dark fs-3 m-0" to="agregar-clientes">
          ...
          <li className="nav-item d-flex align-items-center mt-3 seleccionar w-100">
            ...
            <Link
              className="nav-link text-dark fs-3 m-0"
              to="reportes-analiticos"
            >
              Reportes Analiticos
            </Link>
          </li>
          <li className="text-secondary fs-3 mt-5">PLD</li>
          <li className="nav-item d-flex align-items-center mt-3 seleccionar w-100">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
            ...
            <Link
              className="nav-link text-dark fs-3 m-0"
              to="consultas-avisos-presentados"
            >
